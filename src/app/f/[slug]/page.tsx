...
export async function generateMetadata({ params }: Params): Promise<Metadata> {
  ...
  // Superficie con el mismo criterio que la ficha/OG (helper `fireSurface`):
  // oficial/EFFIS si la hay; si no, estimación por focos FIRMS marcada «~»; si
  // tampoco, «sin dato» (evita el «0 ha» al compartir un incendio sin cifra).
  const haStr = fireSurface(fire).label;
